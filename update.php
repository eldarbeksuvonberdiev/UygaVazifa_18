...
<body class="bg-secondary">
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="container mt-5">
            <h1>Update Talabalar</h1>
            <a href="index.php" class="btn btn-primary mt-2">Talabalar</a>
            <div class="mb-3 mt-4">
                <label for="name" class="form-label">Name</label>
                <input type="text" name="name" class="form-control" id="name" value="<?=$talaba->fio?>">
            </div>
            <div class="mb-3 mt-4">
                <label for="tel" class="form-label">Telefon</label>
                <input type="text" name="tel" class="form-control" id="tel" value="<?=$talaba->tel?>">
            </div>
            <div class="mb-3 mt-4">
                <label for="manzil" class="form-label">Manzil</label>
                <input type="text" name="manzil" class="form-control" id="manzil" value="<?=$talaba->manzil?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="info" id="info" style="width: 100%;border-radius:10px;padding: 10px 10px 5px 10px"><?=$talaba->info?> </textarea>
            </div>
